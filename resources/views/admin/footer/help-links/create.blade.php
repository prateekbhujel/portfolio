...
@section('title','Create Help Link')
            ...
            <div class="card-body">
                <form action="{{ route('admin.footer-help-links.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="text" name="url" class="form-control" value="{{ old('url') }}" placeholder="https://www.meddium.com/useful-content-ever">
                        </div>
                      </div>
