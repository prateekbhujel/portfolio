        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            {{-- <div class="login-brand">
              <img src="{{ asset('public/assets/img/stisla-fill.svg') }}" alt="logo" width="100" class="shadow-light rounded-circle">
            </div> --}}
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Reset Your Password</h4></div>
                ...
                @if (session('status'))
                    <p class="text-success mx-4">{{ session('status') }}</p>    
                @endif
                ...
                <form method="POST" action="{{ route('password.store') }}" class="needs-validation" novalidate="">
                 @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input id="password_confirmation" type="password" class="form-control" name="password_confirmation" tabindex="3" required autofocus>
